...
https://github.com/DeepPSP/torch_ecg/tree/af5e3d7ae879602cc4b0388f145a67efb95a6f58/benchmarks/train_crnn_cinc2020
"""
...
from utils_cinc2020 import ReprMixin, ensure_siglen, list_sum
from torch_ecg.utils.utils_signal import remove_spikes_naive

if cfg_cinc2020.ModelCfg.torch_dtype == torch.float64:
            ...
            for t in _TRANCHES:
                with tqdm(
                    ...
                    for rec in bar:
                        ...
                        rec_labels = [
                            c for c in rec_labels if c in cfg_cinc2020.TrainCfg.tranche_classes[t]
                        ]
                        if len(rec_labels) == 0:
            ...
            for t in _TRANCHES:
                ...
                while not is_valid:
                    ...
                    is_valid = self._check_train_test_split_validity(
                        train_set[t], test_set[t], set(cfg_cinc2020.TrainCfg.tranche_classes[t])
                    )
