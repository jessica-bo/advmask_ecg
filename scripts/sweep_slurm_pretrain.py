...
sweep_name = "pretrain_cinc2021_resnet" # "pretrain_chapman_resnet_augmentations" # 
...
augmentations = ["--threeKG"] #, "--gaussian", "--powerline", "--blockmask", "--mask", "--wander", "--shift", "--rlm", "--emg"]
        ...
        for mask_ratio in mask_ratios: 
            for embedding_dim in embedding_dims:
                for augmentation in augmentations:
                    ...
                    hyperparams_name = "lr{}_bs{}_resnet{}{}".format(lr, batch_size, embedding_dim, augmentation)
                    ...
                    with open(job_file, 'w') as fh:
                        ...
                        fh.writelines("python /home/gridsan/ybo/advaug/main_pretrain.py \
                                        ...
                                        {} \
                                        --mask_ratio {} \
                                        --weight_decay 0 \n".format(seed, num_devices, simclr_loss_flag, sweep_name, hyperparams_name, lr, batch_size, embedding_dim, augmentation, mask_ratio))
