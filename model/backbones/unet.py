...
class unet1Dsmall(nn.Module):
    def __init__(self, input_dim, embedding_dim, kernel_size, depth, nmasks):
...
class unet1D(nn.Module):
    def __init__(self, input_dim, embedding_dim, kernel_size, depth, nmasks):
        ...
        self.layer1 = self.down_layer(self.input_dim, self.embedding_dim, self.kernel_size,1, 2)
        self.layer2 = self.down_layer(self.embedding_dim, int(self.embedding_dim*2), self.kernel_size,5, 2)
        self.layer3 = self.down_layer(int(self.embedding_dim*2)+int(self.input_dim), int(self.embedding_dim*3), self.kernel_size,5, 2)
        self.layer4 = self.down_layer(int(self.embedding_dim*3)+int(self.input_dim), int(self.embedding_dim*4), self.kernel_size,5, 2)
        self.layer5 = self.down_layer(int(self.embedding_dim*4)+int(self.input_dim), int(self.embedding_dim*5), self.kernel_size,4, 2)
